...
def writeH5File(path_to_simconfig,segment_position_folder,outputfile,neurons_per_file,files_per_folder,sigma=[0.277],path_to_fields=None,objective_csd_array_indices=None):
    ...
    segment_position_folder refers to the path to the top-level folder containing pickle files with the position of each segment. This is generated by the get_positions() function
